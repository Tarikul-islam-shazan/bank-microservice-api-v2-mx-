...
import sendgridConfig from '../sendgrid/sendgrid.development';

const devConfig = {
  app: {
    title: 'meed banking club service dev',
    baseUrl: '/api/'
  },
  port: process.env.PORT || 6064,
  database: {
    url: `mongodb://localhost:27017/meedv2-dev`
  },
  session: {
  ...
  api: {
    axxiome: {
      url: 'https://10.100.0.232:8243',
      username: 'EAlFtcZtmdXICu0G9Ynud_O0E6Aa',
      password: 'YBOXEH5_ZhAZmPE3NdTwWSJ1YmMa',
      secKey: 'TUVFRF9BUElfVVNFUjo1OFV6UXpiRUZoeDllVW5I',
      version: '2.2.0'
    },
    invex: {
